...
export default function CommentForm({ onSubmit, placeholder, replyTo, initialValue = '' }: CommentFormProps) {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-3xl p-4 shadow-sm focus-within:ring-2 focus-within:ring-green-500/20 focus-within:border-green-500 transition-all">
      {replyTo && (
